...
// Upstream (wonho-maker/Adafruit_SH1106) targets AVR only and unconditionally
// pulls in AVR-specific headers/registers that don't exist on ESP32. Neither
// is actually used by the I2C code path this project exercises, so they're
// just guarded out on non-AVR builds instead of being ported.
#if defined(__AVR__)
